...
typedef void (*I2C_SendFunc_t)(uint8_t deviceAddress, uint8_t subAddress, uint8_t txBuff);
typedef void (*I2C_ReceiveFunc_t)(uint8_t deviceAddress, uint8_t subAddress, uint8_t *rxBuff, uint8_t rxBuffSize);
